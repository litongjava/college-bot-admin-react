...
import {rumi_rmp_school_rating_columns} from "@/pages/app/rumi_rmp_school_rating/rumi_rmp_school_rating_column";

export default () => {
  const from = 'rumi_rmp_school_rating';
  ...
  return (
    <ApiTableLong
      from={from}
      columns={rumi_rmp_school_rating_columns()}
